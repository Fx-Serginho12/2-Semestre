class Program
{
    public static void Main()
    {
        ...
        {
            //num é variável que gerando a tabuada
        ...
        int[] notas = new int[4];
        //Declarar um vetor atribuindo valor
        ...
        //Foreach / para cada elemento do vetor alunos fazer a tarefa de somar  descobrir o maior e menor
